...
set ::env(RCX_RULESETS) "\"nom_*\" /opt/pdks/ihp-sg13g2/libs.tech/librelane/openrcx/IHP_rcx_patterns.rules"
...
set ::env(RCX_RULESET) /opt/pdks/ihp-sg13g2/libs.tech/librelane/openrcx/IHP_rcx_patterns.rules
set ::env(SAVE_SPEF) /home/designer/shared/runs/RUN_2026-05-16_00-03-42/54-openroad-rcx/nom/sram.nom.spef
