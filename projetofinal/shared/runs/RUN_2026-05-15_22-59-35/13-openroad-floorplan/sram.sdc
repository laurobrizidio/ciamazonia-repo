...
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {oe_n}]
...
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {we_n}]
...
set_driving_cell -lib_cell sg13g2_buf_4 -pin {X} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {oe_n}]
set_driving_cell -lib_cell sg13g2_buf_4 -pin {X} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {we_n}]
